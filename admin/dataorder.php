...
$query = "SELECT * FROM transaction WHERE status = 'Terverifikasi' ";
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-4 mb-2 mb-lg-0 ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php">Verification</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="dataorder.php"
                            style="color: #FB2E86;">Orders</a>
                    </li>
                    <li class="nav-item">
                        <p class="nav-link">|</a>
                    </li>
    ...
    <table class="table mt-4">
        ...
        <?php else : ?>
        <h3 class="" align="center">Belum Ada Data</h3>
        <?php endif; ?>
    </table>
    <!-- Akhir Data Order -->
    <!-- About -->
