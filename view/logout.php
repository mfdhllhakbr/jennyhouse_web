...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-4 mb-2 mb-lg-0 ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="logout.php" style="color: #FB2E86;">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section>
        <div class="container" id="reg-header">
            <h1>Logout</h1>
            <p class="fs-5">Ready to go away from heaven?</p>
        </div>
    </section>
    <!-- Akhir Header -->
    <!-- Logout -->
    <div class="container w-50 mt-3 mb-3" style="padding: 7rem;">
        <div class="card text-center " style="background: #F8F8FD;">
            <div class="card-body">
                ...
                <p class="card-text">Are you sure dude?</p>
